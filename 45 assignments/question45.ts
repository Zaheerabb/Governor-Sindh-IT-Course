/*
Question 45: Cars: Write a function that stores information about a car in a Object. The function should 
...
function carDetails(name:string,company:string, extra: Record<string, any>):car {
    return{
        company: company,
        name: name,
        ...extra
